    ...
    , m_show_history_dialog(show)
{
    ...
    mew_btn->SetBorderColor(wxColour(37, 115, 217));
...
void HistoryWindow::sync_history_data() {
    ...
    for (auto& result : m_calib_results_history) {
        ...
        edit_button->SetBorderColor(wxColour(37, 115, 217));
    ...
    , m_old_name(result.name)
{
    ...
    save_btn->SetBorderColor(wxColour(37, 115, 217));
    ...
    , m_history_results(history_results)
{
    ...
    ok_btn->SetBorderColor(wxColour(37, 115, 217));
