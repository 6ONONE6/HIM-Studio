                ...
                /*wxCAPTION*/ wxDEFAULT_DIALOG_STYLE)
{
    ...
    text_list.push_back(_L("HIM-Studio is based on OrcaSlicer.")); // suKing
    ...
    // wxStaticText* html_text = new wxStaticText(this, wxID_ANY, "Copyright(C) 2022-2024 Li Jiang All Rights Reserved", wxDefaultPosition,
    //                                            wxDefaultSize);
    wxStaticText* html_text = new wxStaticText(this, wxID_ANY, " ", wxDefaultPosition,
                                               wxDefaultSize); //  suKing
    ...
    m_html = new wxHtmlWindow(this, wxID_ANY, wxDefaultPosition, wxDefaultSize, wxHW_SCROLLBAR_NEVER /*NEVER*/);
    {
        ...
        const auto text = from_u8(
            (boost::format("<html>"
                           ...
                           "href=\"https://github.com/SoftFever/Orcaslicer\">https://github.com/SoftFever/Orcaslicer</ a></p>"
                           "</body>"
                           "</html>"))
                .str());
        // m_html->SetPage(text);
        m_html->SetPage(""); //  suKing
        copyright_ver_sizer->Add(m_html, 0, wxEXPAND, 0);
        // m_html->Bind(wxEVT_HTML_LINK_CLICKED, &AboutDialog::onLinkClicked, this); //  suKing
    }
