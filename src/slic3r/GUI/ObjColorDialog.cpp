...
const  StateColor ok_btn_bg(std::pair<wxColour, int>(wxColour(27, 85, 161), StateColor::Pressed),
...
{
    auto       btn_sizer = new wxBoxSizer(wxHORIZONTAL);
    StateColor calc_btn_bg(std::pair<wxColour, int>(wxColour(27, 85, 161), StateColor::Pressed), std::pair<wxColour, int>(wxColour(43, 135, 255), StateColor::Hovered),
                           std::pair<wxColour, int>(wxColour(37, 115, 217), StateColor::Normal));
