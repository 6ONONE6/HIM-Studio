...
wxString WipingDialog::BuildTextObjStr(bool multi_language)
{
    ...
    if (multi_language) {
        auto_flush_tip = _L("HimStudio would re-calculate your flushing volumes everytime the filaments color changed or filaments changed. You could disable the auto-calculate in HimStudio > Preferences");
        ...
        auto_flush_tip = "HimStudio would re-calculate your flushing volumes everytime the filaments color changed or filaments changed. You could disable the auto-calculate in HimStudio > Preferences";
