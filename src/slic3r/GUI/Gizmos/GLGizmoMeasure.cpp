...
void GLGizmoMeasure::show_face_face_assembly_common() {
    if (m_measure_mode == EMeasureMode::ONLY_ASSEMBLY && m_hit_different_volumes.size() == 2 &&
        ...
        m_imgui->disabled_begin(!(action.can_set_to_center_coincidence));
        {
            ...
            ImGui::PushStyleColor(ImGuiCol_Button, ImVec4(37 / 255.0, 115 / 255.0, 217 / 255.0, 1.0));
            ImGui::PushStyleColor(ImGuiCol_ButtonHovered, ImVec4(43 / 255.0f, 135 / 255.0f, 255 / 255.0f, 1.00f));
            ImGui::PushStyleColor(ImGuiCol_ButtonActive, ImVec4(27 / 255.0f, 85 / 255.0f, 161 / 255.0f, 1.00f));
