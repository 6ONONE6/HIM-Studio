...
static std::map<wxColour, wxColour> gDarkColors{
    {"#2573D9", "#1E5FB3"}, // rgb(37, 115, 217)    ORCA color
    ...
    //{"#F0F0F0", "#4C4C54"},
    // ORCA
    {"#93b4df", "#7C98BD"}, // rgb(191, 225, 222)  Dropdown checked item background color > ORCA color with %25 opacity
    {"#BAD7ED", "#A0B9CC"}, // rgb(229, 240, 238)  Combo / Dropdown focused background color > ORCA color with %10 opacity
};
