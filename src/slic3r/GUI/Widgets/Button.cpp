    ...
    : paddingSize(10, 8)
{
    background_color = StateColor(
        ...
        std::make_pair(0x2B87FF, (int) StateColor::Hovered | StateColor::Checked),
        std::make_pair(0x2573D9, (int) StateColor::Checked),
...
wxString btn_regular[10]  = {"#DFDFDF", "#DFDFDF", "#D4D4D4", "#DFDFDF", "#DFDFDF", "#6B6A6A", "#262E30", "#262E30", "#2573D9", "#2573D9"};
wxString btn_confirm[10]  = {"#DFDFDF", "#2573D9", "#2A83F7", "#2573D9", "#2573D9", "#6B6A6A", "#FEFEFE", "#FEFEFE", "#2A83F7", "#00FFD4"};
wxString btn_alert[10]    = {"#DFDFDF", "#DFDFDF", "#E14747", "#DFDFDF", "#DFDFDF", "#6B6A6A", "#262E30", "#FFFFFD", "#2573D9", "#2573D9"};
