	...
	, m_notification_start  (GLCanvas3D::timestamp_now())
{
    ...
    m_NormalColor = ImVec4(37.0f / 255.0f, 115.0f / 255.0f, 217.0f / 255.0f, 1);

	m_CurrentColor = m_NormalColor;   //Default

	m_WindowBkgColor = ImVec4(1, 1, 1, 1);
    m_TextColor      = ImVec4(.2f, .2f, .2f, 1.0f);
    m_HyperTextColor = ImVec4(37.0f / 255.0f, 115.0f / 255.0f, 217.0f / 255.0f, 1);
}
...
void NotificationManager::PopNotification::use_bbl_theme()
{
 ...
 //   OldStyle.Colors[ImGuiCol_Text]     = m_TextColor;
	...
	m_HyperTextColor = m_is_dark ? ImVec4(37.0f / 255.0f, 115.0f / 255.0f, 217.0f / 255.0f, 1) : ImVec4(37.0f / 255.0f, 115.0f / 255.0f, 217.0f / 255.0f, 1);
	m_HyperTextColorHover = m_is_dark ? ImVec4(42.f / 255.f, 131.f / 255.f, 247.f / 255.f, 1) : ImVec4(31.f / 255.f, 96.f / 255.f, 181.f / 255.f, 1); //#2A83F7 / #1F60B5;
