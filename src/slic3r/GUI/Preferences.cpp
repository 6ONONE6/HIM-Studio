...
void PreferencesDialog::create_items()
{
    ...
    auto item_single_instance  = create_item_checkbox(_L("Allow only one HIM Studio instance"),
    #if __APPLE__
    ...
    auto item_associate_3mf    = create_item_checkbox(_L("Associate 3MF files to HimStudio"), _L("If enabled, this sets HimStudio as the default application to open 3MF files.") , "associate_3mf");
    ...
    auto item_associate_stl    = create_item_checkbox(_L("Associate STL files to HimStudio"), _L("If enabled, this sets HimStudio as the default application to open STL files.") , "associate_stl");
    g_sizer->Add(item_associate_stl);

    auto item_associate_step   = create_item_checkbox(_L("Associate STEP files to HimStudio"), _L("If enabled, this sets HimStudio as the default application to open STEP files."), "associate_step");
