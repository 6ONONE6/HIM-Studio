...
void ImGuiWrapper::push_confirm_button_style()
{
    if (m_is_dark_mode) {
        ...
        // ImGui::PushStyleColor(ImGuiCol_ButtonHovered, to_ImVec4(decode_color_to_float_array("#6BA811"))); // suKing
        ...
        // ImGui::PushStyleColor(ImGuiCol_ButtonHovered, to_ImVec4(decode_color_to_float_array("#9DF619"))); // suKing
        ImGui::PushStyleColor(ImGuiCol_ButtonActive, ImVec4(27.f / 255.f, 136.f / 255.f, 68.f / 255.f, 1.f));
...
void ImGuiWrapper::pop_radio_style() { ImGui::PopStyleColor(1); }
...
void ImGuiWrapper::render_draw_data(ImDrawData* draw_data)
{
    ...
    glsafe(::glGetIntegerv(GL_POLYGON_MODE, last_polygon_mode));
    GLint last_viewport[4];
    glsafe(::glGetIntegerv(GL_VIEWPORT, last_viewport));
    GLint last_scissor_box[4];
    glsafe(::glGetIntegerv(GL_SCISSOR_BOX, last_scissor_box));
    GLint last_texture_env_mode;
    glsafe(::glGetTexEnviv(GL_TEXTURE_ENV, GL_TEXTURE_ENV_MODE, &last_texture_env_mode));
    ...
    glsafe(::glPopAttrib());
    glsafe(::glPolygonMode(GL_FRONT, (GLenum) last_polygon_mode[0]); glsafe(::glPolygonMode(GL_BACK, (GLenum) last_polygon_mode[1])));
