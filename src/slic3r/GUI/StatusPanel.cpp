...
static const wxColour BUTTON_HOVER_COL   = wxColour(37, 115, 217);
...
static const wxColour STAGE_TEXT_COL      = wxColour(37, 115, 217);
...
void PrintingTaskPanel::create_panel(wxWindow* parent)
{
    ...
    m_staticText_progress_percent->SetForegroundColour(wxColour(37, 115, 217));
    ...
    m_staticText_progress_percent_icon->SetForegroundColour(wxColour(37, 115, 217));
    ...
    StateColor btn_bg_green(std::pair<wxColour, int>(AMS_CONTROL_DISABLE_COLOUR, StateColor::Disabled), std::pair<wxColour, int>(wxColour(27, 85, 161), StateColor::Pressed),
                            std::pair<wxColour, int>(wxColour(43, 135, 255), StateColor::Hovered), std::pair<wxColour, int>(AMS_CONTROL_BRAND_COLOUR, StateColor::Normal));
...
wxBoxSizer *StatusBasePanel::create_misc_control(wxWindow *parent)
{
    ...
    m_switch_nozzle_fan->Bind(wxEVT_ENTER_WINDOW, [this](auto& e) {
        m_fan_panel->SetBackgroundColor(wxColour(37, 115, 217));
    });
