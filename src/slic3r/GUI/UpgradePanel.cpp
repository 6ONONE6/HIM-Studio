...
static const wxColour TEXT_NORMAL_CLR = wxColour(37, 115, 217);
    ...
    :wxPanel(parent, id, pos, size, style)
{
    ...
    StateColor btn_bg(std::pair<wxColour, int>(wxColour(255, 255, 255), StateColor::Disabled), std::pair<wxColour, int>(wxColour(27, 85, 161), StateColor::Pressed),
                      std::pair<wxColour, int>(wxColour(43, 135, 255), StateColor::Hovered), std::pair<wxColour, int>(wxColour(37, 115, 217), StateColor::Enabled),
                      std::pair<wxColour, int>(wxColour(37, 115, 217), StateColor::Normal));
    StateColor btn_bd(std::pair<wxColour, int>(wxColour(144, 144, 144), StateColor::Disabled), std::pair<wxColour, int>(wxColour(37, 115, 217), StateColor::Enabled));
