...
static wxMenu* generate_help_menu()
{
    ...
    append_menu_item(
        ...
        [](wxCommandEvent&) { wxGetApp().check_new_version_hs(true, 1); }, "", nullptr, []() { return true; });
...
void MainFrame::init_menubar_as_editor()
{
    ...
    if (m_plater != nullptr) {
        ...
        // BBS undo
        append_menu_item(
            editMenu, wxID_ANY, _L("Undo") + "\t" + ctrl + "Z", _L("Undo"),
        ...
        // BBS Select All
        append_menu_item(
            editMenu, wxID_ANY, _L("Select all") + "\t" + ctrl + "A", _L("Selects all objects"),
            [this, handle_key_event](wxCommandEvent&) {
                wxKeyEvent e;
                e.SetEventType(wxEVT_KEY_DOWN);
                e.SetControlDown(true);
    ...
    if (m_plater) {
        ...
        viewMenu->AppendSeparator();
        append_menu_check_item(
            viewMenu, wxID_ANY, _L("Show &G-code Window") + "\tC", _L("Show g-code window in Preview scene"),
            [this](wxCommandEvent&) {
        ...
        append_menu_check_item(viewMenu, wxID_ANY, _L("Show &Wireframe") + "\tCtrl+Shift+Enter", _L("Show wireframes in 3D scene"),
            [this](wxCommandEvent&) { m_plater->toggle_show_wireframe(); m_plater->get_current_canvas3D()->post_event(SimpleEvent(wxEVT_PAINT));
        }, this, [this]() { return m_plater->is_wireframe_enabled(); }, [this]() { return m_plater->is_show_wireframe(); }, this);*/
    ...
    append_menu_item(
        m_topbar->GetCalibMenu(), wxID_ANY, _L("Orca Tolerance Test"), _L("Orca Tolerance Test"),
        [this](wxCommandEvent&) {
            m_plater->new_project();
    ...
    append_menu_item(
        ...
        [this](wxCommandEvent&) {
            wxLaunchDefaultBrowser("https://github.com/SoftFever/OrcaSlicer/wiki/Calibration", wxBROWSER_NEW_WINDOW);
        },
        "", nullptr,
        [this]() {
            return m_plater->is_view3D_shown();
