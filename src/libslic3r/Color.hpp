...
public:
    ...
    static const ColorRGB ORCA()		{ return { 37.0f / 255.0f, 115.0f / 255.0f, 217.0f / 255.0f}; }
...
public:
    ...
    static const ColorRGBA ORCA()        { return { 37.0f / 255.0f, 115.0f / 255.0f, 217.0f / 255.0f, 1.0f}; }
